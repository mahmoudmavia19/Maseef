...
class ErrorHandler implements Exception {
 ...
 class ResponseMessage {
   ...
   static const String INVALID_EMAIL = "Badly formatted email address";
   ...
   static const String USER_NOT_FOUND = "No user record matching this identifier. Perhaps the user was deleted";
   static const String USER_DISABLED = "The user account has been disabled";
   static const String EMAIL_ALREADY_IN_USE = "The email address is already in use by another account";
   ...
   static const String InvalidCredential = "The supplied auth credential is incorrect, malformed or has expired.";
 }
