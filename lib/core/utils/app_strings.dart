...
class AppStrings {
    ...
    static const String stationLocation = "Station Location";
    static const String address = "Address";
    static const String driver = "Driver";
    static const String busDetails = "Bus Details";
    static const String pickImage = 'Pick Image';
    static const String complaintsManagementTitle = "Complaints Management";
    static const String addComplaint = "Add Complaint";
    static const String customerNameLabel = "Customer Name";
    static const String descriptionLabel = "Description";
    static const String submitComplaintButton = "Submit Complaint";
    static const String resolveButton = "Resolve";
    static const String driversManagementTitle = "Drivers Management";
