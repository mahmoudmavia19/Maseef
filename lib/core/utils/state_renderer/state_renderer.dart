  ...
  Widget _getStateWidget() {
    switch (stateRendererType) {
      case StateRendererType.popupLoadingState:
        return _getPopUpDialog([_getAnimatedImage(AppLotteAssets.loading)]);
      case StateRendererType.popupErrorState:
        return _getPopUpDialog([
          _getAnimatedImage(AppLotteAssets.error),
          _getMessage(message),
          _getRetryButton(AppStrings.yes)
        ]);
      case StateRendererType.fullScreenLoadingState:
        return _getItemsColumn(
            [_getAnimatedImage(AppLotteAssets.loading), _getMessage(message)]);
      ...
      case StateRendererType.fullScreenEmptyState:
        return _getItemsColumn(
            [_getAnimatedImage(AppLotteAssets.error), _getMessage(message)]);
      case StateRendererType.popupSuccessState:
        return _getPopUpDialog([
          _getAnimatedImage(AppLotteAssets.success),
          _getMessage(message),
          _getRetryButton(AppStrings.yes)
        ]);
      case StateRendererType.fullScreenSuccessState:
        return _getItemsColumn(
            [_getAnimatedImage(AppLotteAssets.success), _getMessage(message)]);
