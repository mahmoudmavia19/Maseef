  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ScaffoldBackground(
          child: Obx(() =>
              controller.getState.getScreenWidget(_widget(context), () {}))),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: CustomDropDown(
                  ...
                  onChanged: (p0) {
                    controller.category = p0.value;
                  },
                  variant: DropDownVariant.None,
                  items: controller.categories.map((e) => SelectionPopupModel(title: e.name,value: e)).toList(),
                ),
              ),
              SizedBox(height: 16.0),
              ElevatedButton(
              ...
              Obx(() {
                return (controller.selectedImage.value != null)
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(
                                color: ColorConstant.primary, width: 2.0),
                ...
                return Container(
                  ...
                  child: GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      target: LatLng(
                        controller.currentLocation_.value.latitude ??
                            startMapLocation.latitude,
                        controller.currentLocation_.value.longitude ??
                    ...
                    onMapCreated: (_controller) {
                      controller.mapController =
                          _controller; // Do other initialization as needed
                    },
                    onTap: (argument) {
                      print(argument);
